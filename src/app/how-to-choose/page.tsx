...
const CLEANING_METHODS = [
  ...
  },
  {
    ...
    description:
      <>Combines direct spray impingement with full immersion and rotational basket agitation through separate wash and rinse stages. <a href="/solutions/aisi-304-stainless-steel-parts-washers" className="text-magido-orange hover:text-magido-blue font-medium">AISI 304 stainless steel</a>, made in Italy. Specified for aerospace, automotive, and precision machining applications requiring validated cleanliness.</>,
