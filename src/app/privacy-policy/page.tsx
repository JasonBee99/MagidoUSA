...
export const metadata: Metadata = {
  ...
  alternates: { canonical: privacyPolicy.meta.canonical },
  openGraph: {
    title: privacyPolicy.meta.title,
    description: privacyPolicy.meta.description,
    ...
    <>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="max-w-3xl">
            ...
            <div className="mt-3 flex items-center gap-3">
              ...
              <div className="h-px max-w-[8rem] flex-1 bg-magido-orange/30" />
            </div>
            <p className="mt-4 text-justify text-base leading-relaxed text-gray-300">
              {hero.description}
            </p>
            <p className="mt-3 text-sm text-white/40">Last updated: {meta.lastUpdated}</p>
          </div>
        </div>
      </section>
      ...
      <article className="px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        <div className="mx-auto max-w-3xl">
          ...
          {/* Sections — all driven from privacyPolicy.sections */}
                  ...
                  {'list' in section && section.list && (
                    <ul className="mt-2 space-y-1.5 pl-4">
                      {section.list.map((item, i) => (
                        <li key={i} className="flex items-start gap-2 text-sm leading-relaxed text-[var(--color-text-secondary)]">
