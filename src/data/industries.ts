...
export const INDUSTRIES: Industry[] = [
  ...
  },
  {
    ...
    description:
      'Food processing facilities require cleaning equipment that meets food-grade material standards, handles food residues and sanitation chemicals, and supports HACCP-compliant cleaning programs. Magido <a href="/solutions/aisi-304-stainless-steel-parts-washers" class="text-[#eb6c1c] hover:text-[#315687] font-medium">AISI 304 stainless steel</a> construction is inherently food-grade — with no painted surfaces, no hidden carbon steel, and no areas that trap contamination.',
    ...
    metaDescription:
      'Food-grade parts washers — <a href="/solutions/aisi-304-stainless-steel-parts-washers" class="text-[#eb6c1c] hover:text-[#315687] font-medium">AISI 304 stainless steel</a> aqueous cleaning systems for food processing equipment, tooling, and components.',
  },
];
