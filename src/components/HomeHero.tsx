      ...
      <section className="hero-bg relative px-4 pt-6 pb-12 sm:px-6 lg:px-8 lg:pt-10 lg:pb-24">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="relative z-10 mb-4 flex justify-center lg:hidden">
            <a
              href="tel:8444624436"
              className="inline-flex items-center gap-2 rounded-full border border-magido-orange/50 bg-magido-blue/80 px-4 py-1.5 text-xs font-medium text-white transition-colors hover:bg-magido-blue"
            >
